    ...
    ui(new Ui::Dialog4)
{
    ui->setupUi(this);
    //Dialog1 d;
    //QMessageBox::information(this,"t",d.NAME1);
}
...
void Dialog4::on_Dialog4_accepted(int a,int b,QString c,QString d,QString e,QString f,QString g,QString h,double a1,double b1,double c1,double d1,double e1,double f1)
{
    QFont font;
